...
interface IEscrow {
    ...
    event DepositReceived(uint256 indexed propertyId, address indexed investor, address indexed stablecoin, uint256 amount);
    ...
    event RefundIssued(uint256 indexed propertyId, address indexed investor, address indexed stablecoin, uint256 amount);

    /// @notice Emitted when funds are withdrawn to a realtor
    event WithdrawToExecuted(uint256 indexed propertyId, address indexed investor, address indexed recipient, address stablecoin, uint256 amount);
