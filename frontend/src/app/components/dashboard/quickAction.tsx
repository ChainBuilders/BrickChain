import { Plus, Download, Eye, UserPlus, Mail, SquareStack, Search, Goal, Text, Users } from 'lucide-react'
import React from 'react'
type QuickActionProps = {
  user?: string;
};
export default function QuickAction({user}: QuickActionProps) {
    ...
    <div className="w-full bg-white rounded-lg shadow-lg">
      ...
      {user && user === 'realtor' ? (
        <div className="p-6 pt-0 space-y-3">
          <button className="inline-flex items-center justify-center w-full gap-2 whitespace-nowrap rounded-md px-4 py-2 text-white h-10 font-medium outline-none bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700">
            <Plus color="white" /> <span>List New Property</span>
          </button>
          <button className="inline-flex items-center justify-center gap-2 w-full border border-stone-400 whitespace-nowrap rounded-md px-4 py-2 hover:bg-slate-100 h-10 font-medium outline-none text-black">
            <UserPlus color="black" /> <span>Manage client Relationship</span>
          </button>
          <button className="inline-flex items-center justify-center gap-2 w-full border border-stone-400 whitespace-nowrap rounded-md px-4 py-2 hover:bg-slate-100 h-10 font-medium outline-none text-black">
            <Mail color="black" /> <span> Marketing Tools</span>
          </button>
          <button className="inline-flex items-center justify-center gap-2 w-full border border-stone-400 whitespace-nowrap rounded-md px-4 py-2 hover:bg-slate-100 h-10 font-medium outline-none text-black">
            <SquareStack color="black" /> <span> Commission Reports</span>
          </button>
        </div>
      ) : (
        <div className="p-6 pt-0 space-y-3">
